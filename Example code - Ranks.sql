...
FROM (SELECT ifnull(Richard, 'Missing') AS Score FROM "@Stargate_SG1" UNION SELECT ifnull(Michael, 'Missing') AS Score FROM "@Stargate_SG1" UNION SELECT ifnull(Amanda, 'Missing') AS Score FROM "@Stargate_SG1" UNION SELECT ifnull(Chris, 'Missing') AS Score FROM "@Stargate_SG1"
	...
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Richard, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S%%' GROUP BY scores) scoreSRichard ON scoreSRichard.scores = Score
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Michael, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S%%' GROUP BY scores) scoreSMichael ON scoreSMichael.scores = Score
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Amanda, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S%%' GROUP BY scores) scoreSAmanda ON scoreSAmanda.scores = Score
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Chris, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S%%' GROUP BY scores) scoreSChris ON scoreSChris.scores = Score
...
FROM (SELECT ifnull(Richard, 'Missing') AS Score_S01 FROM "@Stargate_SG1" UNION SELECT ifnull(Michael, 'Missing') AS Score_S01 FROM "@Stargate_SG1" UNION SELECT ifnull(Amanda, 'Missing') AS Score_S01 FROM "@Stargate_SG1" UNION SELECT ifnull(Chris, 'Missing') AS Score_S01 FROM "@Stargate_SG1"
	...
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Richard, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S01%%' GROUP BY scores) scoreS01Richard ON scoreS01Richard.scores = Score_S01
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Michael, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S01%%' GROUP BY scores) scoreS01Michael ON scoreS01Michael.scores = Score_S01
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Amanda, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S01%%' GROUP BY scores) scoreS01Amanda ON scoreS01Amanda.scores = Score_S01
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Chris, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S01%%' GROUP BY scores) scoreS01Chris ON scoreS01Chris.scores = Score_S01
...
FROM (SELECT ifnull(Richard, 'Missing') AS Score_S02 FROM "@Stargate_SG1" UNION SELECT ifnull(Michael, 'Missing') AS Score_S02 FROM "@Stargate_SG1" UNION SELECT ifnull(Amanda, 'Missing') AS Score_S02 FROM "@Stargate_SG1" UNION SELECT ifnull(Chris, 'Missing') AS Score_S02 FROM "@Stargate_SG1"
	...
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Richard, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S02%%' GROUP BY scores) scoreS02Richard ON scoreS02Richard.scores = Score_S02
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Michael, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S02%%' GROUP BY scores) scoreS02Michael ON scoreS02Michael.scores = Score_S02
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Amanda, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S02%%' GROUP BY scores) scoreS02Amanda ON scoreS02Amanda.scores = Score_S02
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Chris, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S02%%' GROUP BY scores) scoreS02Chris ON scoreS02Chris.scores = Score_S02
...
FROM (SELECT ifnull(Richard, 'Missing') AS Score_S03 FROM "@Stargate_SG1" UNION SELECT ifnull(Michael, 'Missing') AS Score_S03 FROM "@Stargate_SG1" UNION SELECT ifnull(Amanda, 'Missing') AS Score_S03 FROM "@Stargate_SG1" UNION SELECT ifnull(Chris, 'Missing') AS Score_S03 FROM "@Stargate_SG1"
	...
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Richard, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S03%%' GROUP BY scores) scoreS03Richard ON scoreS03Richard.scores = Score_S03
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Michael, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S03%%' GROUP BY scores) scoreS03Michael ON scoreS03Michael.scores = Score_S03
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Amanda, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S03%%' GROUP BY scores) scoreS03Amanda ON scoreS03Amanda.scores = Score_S03
	LEFT JOIN (SELECT group_concat('"' || Title || '"', ', ') AS Title, count(Title) AS Counts, ifnull(Chris, 'Missing') AS scores FROM "@Stargate_SG1" WHERE "Episode-Air" LIKE 'S03%%' GROUP BY scores) scoreS03Chris ON scoreS03Chris.scores = Score_S03
